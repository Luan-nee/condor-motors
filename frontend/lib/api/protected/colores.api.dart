...
class ColoresApi {
  ...
  // Constructor que acepta _apiClient como parámetro posicional para mantener
  // compatibilidad con el patrón usado en otras APIs del proyecto
  ColoresApi(this._apiClient);
    ...
    try {
      ...
      if (response.containsKey('data')) {
        ...
        final List<ColorApp> colores =
            jsonData.map((json) => ColorApp.fromJson(json)).toList();
        ...
        throw Exception(
            'Error al obtener colores: Formato de respuesta inesperado');
      }
    } catch (e) {

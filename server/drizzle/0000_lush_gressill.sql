...
CREATE TABLE "inventarios" (
	...
	"fecha_stock_reabastecido" timestamp DEFAULT now() NOT NULL,
	"producto_id" integer NOT NULL,
	"sucursal_id" integer NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "reservas_productos" (
	...
	"fecha_reserva" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "transferencias_inventarios" (
	...
	"cantidad" integer DEFAULT 1 NOT NULL,
	"fecha_transferencia" timestamp DEFAULT now() NOT NULL,
...
ALTER TABLE "devoluciones" ADD CONSTRAINT "devoluciones_sucursal_id_sucursales_id_fk" FOREIGN KEY ("sucursal_id") REFERENCES "public"."sucursales"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "entradas_inventarios" ADD CONSTRAINT "entradas_inventarios_sucursal_id_sucursales_id_fk" FOREIGN KEY ("sucursal_id") REFERENCES "public"."sucursales"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "inventarios" ADD CONSTRAINT "inventarios_sucursal_id_sucursales_id_fk" FOREIGN KEY ("sucursal_id") REFERENCES "public"."sucursales"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "notificaciones" ADD CONSTRAINT "notificaciones_sucursal_id_sucursales_id_fk" FOREIGN KEY ("sucursal_id") REFERENCES "public"."sucursales"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "precios_productos" ADD CONSTRAINT "precios_productos_sucursal_id_sucursales_id_fk" FOREIGN KEY ("sucursal_id") REFERENCES "public"."sucursales"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "proformas_venta" ADD CONSTRAINT "proformas_venta_sucursal_id_sucursales_id_fk" FOREIGN KEY ("sucursal_id") REFERENCES "public"."sucursales"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "reservas_productos" ADD CONSTRAINT "reservas_productos_sucursal_id_sucursales_id_fk" FOREIGN KEY ("sucursal_id") REFERENCES "public"."sucursales"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "transferencias_inventarios" ADD CONSTRAINT "transferencias_inventarios_sucursal_origen_id_sucursales_id_fk" FOREIGN KEY ("sucursal_origen_id") REFERENCES "public"."sucursales"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "transferencias_inventarios" ADD CONSTRAINT "transferencias_inventarios_sucursal_destino_id_sucursales_id_fk" FOREIGN KEY ("sucursal_destino_id") REFERENCES "public"."sucursales"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
